...
internal class Program
{
    ...
    public Program()
    {
        ...
        TecnicoAdministrativo tecnico1 = new TecnicoAdministrativo("Samuel Braz dos Santos", "123.456.789-00", "MG-12.345.678", "30 anos", new Logradouro("Rua A", "Centro", "Cidade X"), "123", "Apto 101", "2023001", 2000, "Desenvolvedor");  
